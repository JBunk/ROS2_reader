...
ServiceNode::ServiceNode(): Node("ServiceNode"){
    ...
    service_ = this->create_service<custom_interfaces::srv::AddThreeInts>(
            "add_three_ints", 
            std::bind(&ServiceNode::add, this, _1, _2));
}

void ServiceNode::add(const std::shared_ptr<custom_interfaces::srv::AddThreeInts::Request> request,
